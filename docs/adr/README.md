...
| [0003](./GUIDERS-FSHARP-ADR-0003-model-extraction-matrix.md) | Model extraction matrix | Accepted | Correspondence (C2 slice) shipped — Modeling.Gdl.Correspondence; Navigation/Graph/Combinations next |
...
| [0005](./GUIDERS-FSHARP-ADR-0005-federation-reframe-cdp-features.md) | Federation reframe CDP | Accepted · In progress | CDP `cdp_ide_session_scene` dogfood; Correspondence modeling shipped |
