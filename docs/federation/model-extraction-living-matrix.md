...
**Next waves:** delete `LegacyBracketRelationWire` after RelationSpec resolve path · Execution package renames (`*.Anchors` → `*.Relations` where applicable) · `FcsProjectOptionsSdkSource` dead code trim.
